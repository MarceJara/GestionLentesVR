...
BEGIN
    INSERT INTO usuario(usuarioid, nombre, apellido, correo, contrasena, fechacreacion, activo)
    VALUES (p_usuarioid, p_nombre, p_apellido, p_correo, p_contrasena, p_fechacreacion, p_activo);
END;
//
...
BEGIN
    INSERT INTO rol(rolid, nombre, descripcion, usuario_usuarioid, activo)
    VALUES (p_rolid, p_nombre, p_descripcion, p_usuario_usuarioid, p_activo);
END;
//
