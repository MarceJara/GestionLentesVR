...
BEGIN
    INSERT INTO metricauso(metricaid, fecharegistro, tiempousominutos, nivelbateriainicial, nivelbateriafinal, usuario_usuarioid, dispositivo_dispositivoid, activo)
    VALUES (p_metricaid, p_fecharegistro, p_tiempousominutos, p_nivelbateriainicial, p_nivelbateriafinal, p_usuario_usuarioid, p_dispositivo_dispositivoid, p_activo);
END;
//
...
BEGIN
    ...
    WHERE metricaid = p_metricaid 
		AND usuario_usuarioid = p_usuario_usuarioid
		AND dispositivo_dispositivoid = p_dispositivo_dispositivoid;
END;
//
